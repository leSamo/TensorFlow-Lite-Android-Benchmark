...
public abstract class Classifier {
  ...
  public static Classifier create(Activity activity, Model model, Device device, int numThreads)
    ...
    if (model == Model.MOBILENETV2_96_Q0_M) {
      ...
      return new Classifier_MobileNetV2_160_Q0_M_(activity, device, numThreads);
    } else if (model == Model.MOBILENETV2_224_Q0_M) {
      return new Classifier_MobileNetV2_224_Q0_M_(activity, device, numThreads);
    } else if (model == Model.MOBILENETV2_224_Q1_M) {
      return new Classifier_MobileNetV2_224_Q1_M_(activity, device, numThreads);
    } else if (model == Model.MOBILENETV2_224_Q2_M) {
      return new Classifier_MobileNetV2_224_Q2_M_(activity, device, numThreads);
    } else if (model == Model.NASNETMOBILE_224_Q0_M) {
      return new Classifier_NASNetMobile_224_Q0_M_(activity, device, numThreads);
    } else {
