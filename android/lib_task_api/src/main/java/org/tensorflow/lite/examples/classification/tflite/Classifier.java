...
public abstract class Classifier {
  ...
  public enum Model {
    ...
    MOBILENETV2_224_Q0_M,
    MOBILENETV2_224_Q1_M,
    MOBILENETV2_224_Q2_M,
    NASNETMOBILE_224_Q0_M;

    static public final Model[] values = values();

    public Model next() {
      return values[(ordinal() + 1) % values.length];
    }

    public Model first() { return values[0]; }
  }
  ...
  public static Classifier create(Activity activity, Model model, Device device, int numThreads)
    ...
    if (model == Model.EFFICIENTNETB0_224_Q0_M) {
      return new Classifier_EfficientNetB0_224_Q0_M(activity, device, numThreads);
    } else if (model == Model.MOBILENETV2_96_Q0_M) {
      return new Classifier_MobileNetV2_96_Q0_M(activity, device, numThreads);
    } else if (model == Model.MOBILENETV2_128_Q0_M) {
      return new Classifier_MobileNetV2_128_Q0_M(activity, device, numThreads);
    } else if (model == Model.MOBILENETV2_160_Q0_M) {
      return new Classifier_MobileNetV2_160_Q0_M(activity, device, numThreads);
    } else if (model == Model.MOBILENETV2_224_Q0_M) {
      return new Classifier_MobileNetV2_224_Q0_M(activity, device, numThreads);
    } else if (model == Model.MOBILENETV2_224_Q1_M) {
      return new Classifier_MobileNetV2_224_Q1_M(activity, device, numThreads);
    } else if (model == Model.MOBILENETV2_224_Q2_M) {
      return new Classifier_MobileNetV2_224_Q2_M(activity, device, numThreads);
    } else if (model == Model.NASNETMOBILE_224_Q0_M) {
      return new Classifier_NASNetMobile_224_Q0_M(activity, device, numThreads);
    } else {
